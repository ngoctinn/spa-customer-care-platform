/**
 * @file src/features/promotion/api/index.ts
 * @description API functions and data hooks for promotions.
 */
 ...
 */
export const createPromotion = async (data: PromotionFormValues): Promise<Promotion> => {
  const payload = {
    ...data,
 ...
 */
export const updatePromotion = async ({ id, data }: { id: string; data: Partial<PromotionFormValues> }): Promise<Promotion> => {
