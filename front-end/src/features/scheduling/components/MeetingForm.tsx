// src/features/scheduling/components/MeetingForm.tsx
"use client";
...
import { fromZonedTime } from "date-fns-tz"; // Cần import thêm
...
export function MeetingForm({
  ...
  async function onSubmit(values: z.infer<typeof meetingFormSchema>) {
    ...
    alert("Form đã được gửi đi (chế độ front-end)! Kiểm tra console log.");
  }
            ...
            render={({ field }) => (
              <FormItem className="flex-1">
                ...
                <Select
                  ...
                  // Sửa đổi ở đây để đảm bảo giá trị là string khi truyền vào Select
